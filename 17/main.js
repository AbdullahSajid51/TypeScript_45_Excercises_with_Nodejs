...
var invitationList = ["Musa", "Danyal", "Bilal", "Salman"];
...
while (invitationList.length > 2) {
    var removeGuest = invitationList.pop();
...
invitationList.forEach(function (lastTwo) {
    return console.log("Luckily ".concat(lastTwo, ", you still Invited.."));
});
console.log(invitationList);
