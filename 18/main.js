...
var favPlaces = ["Denmark", "China", "Najaf", "Brazil", "Australia"];
console.log("Original Order:", favPlaces);
// Print the Array in Alphabetical Order without Modifying the actual list.
console.log("Alphabetical Order:", __spreadArray([], favPlaces, true).sort()); //// ...dots say original array change nhi hoti(Copy banay k liye used hote hain 3dots)
